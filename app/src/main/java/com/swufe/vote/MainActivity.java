...
public class MainActivity extends AppCompatActivity {
    ...
    private String doVote(String voteStr){ String retStr = ""; Log.i("vote", "doVote() voteStr:" + voteStr);
        try {
            ...
            byte[] data = stringBuffer.toString().getBytes(); String urlPath = "http://10.240.13.10:8080/vote/GetVote";
            ...
            if(response == HttpURLConnection.HTTP_OK) { InputStream inputStream = httpURLConnection.getInputStream();
